...
public class MethodReference {
    ...
    private String methodAnnotationDesc = "none";
    private String parameterAnnotationDesc = "none";
    ...
    public MethodReference(ClassReference.Handle classReference, String name, String desc, boolean isStatic, String methodAnnotationDesc, String parameterAnnotationDesc) {
        this.classReference = classReference;
        this.name = name;
        this.desc = desc;
        this.isStatic = isStatic;
        this.methodAnnotationDesc = methodAnnotationDesc;
        this.parameterAnnotationDesc = parameterAnnotationDesc;
    ...
    public String getMethodAnnotationDesc(){
        return this.methodAnnotationDesc;
    }
    public String getParameterAnnotationDesc(){
    ...
    public static class Factory implements DataFactory<MethodReference> {
        ...
        public String[] serialize(MethodReference obj) {
            return new String[] {
                    ...
                    obj.methodAnnotationDesc,
                    obj.parameterAnnotationDesc
            };
        }
    }
}
