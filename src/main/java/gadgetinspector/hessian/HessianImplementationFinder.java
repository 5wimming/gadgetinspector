...
public class HessianImplementationFinder implements ImplementationFinder  {
    ...
    public HessianImplementationFinder(SerializableDecider serializableDecider, Map<MethodReference.Handle, Set<MethodReference.Handle>> methodImplMap) {
